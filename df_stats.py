...
# STATS
aov = pg.anova(dv="RMSE", between=["EMG_objective", "co_contraction_level"], data=df1)
...
aov = pg.anova(dv="RMSE", between=["Marker_noise_level_m", "EMG_objective"], data=df2, detailed=True)
